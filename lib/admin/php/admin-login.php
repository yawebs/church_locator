...
if (isset($_SESSION['admin-login-error'])) {
    ...
    $error = $_SESSION['admin-login-error'];
}
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Abitrep Admin Login</title>
    ...
    <main class="admin-main  ">
        <div class="container-fluid">
            <div class="row ">
                <div class="col-lg-6  bg-white">
                    <div class="row align-items-center m-h-100">
                        <div class="mx-auto col-md-8">
                            <form class="needs-validation" autocomplete="off" action="includes/login_superadmin_inc.php" method="POST">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group floating-label col-md-12">
                                        ...
                                        <input type="password" name="pwd" id="password" required class="form-control " placeholder="Password">
                                ...
                                <button type="submit" name="login-admin-account" class="btn btn-primary btn-block btn-lg">Login</button>
                ...
                <div class="col-lg-6  d-none d-md-block bg-cover" style="background-image: url('../../uploads/Gidyon.jpg');">
