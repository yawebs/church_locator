...
if (isset($_SESSION['this-is-an-incoming-super-admin'])) {
    ...
    if (isset($_SESSION['delete-product-error'])) {
        $actionResult = $_SESSION['delete-product-error'];
    }
            ...
            <div class="container">
                <div class="row p-b-60 p-t-60">
                    ...
                    <div class="col-md-6 text-center mx-auto text-white p-b-30">
                        ...
                        <h3 class="text-dark">Remove Products </h3>
                        <p class="text-success"><?php echo $actionResult;
                                                unset($_SESSION['delete-product-error']) ?></p>
                        <form>
                            <div class="form-dark">
                    ...
                    <?php foreach ($products as $product) { ?>
                            ...
                            <div class="card border-0 " data-aos="fade-right">
                                ...
                                <div class="card-body  bg-dark text-white product-card-border">
                                    ...
                                    <div class="float-right w-75 pt-5 pb-5">
                                        ...
                                        <div class="row">
                                            <a href="<?php echo $product['product_link'] ?>" target="_blank" class="btn bg-light">BUY TATCOIN NOW</a>
                        ...
                        <div class="modal fade" id="logoutModalCenter<?php echo $product['id'] ?>" tabindex="-1" role="dialog" aria-labelledby="logoutModalCenterTitle" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="logoutModalLongTitle">Remove Product</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                        </button>
                                    </div>
                                    <form class="ml-5" id="withdraw_form" method="POST" action="includes/remove_product_inc.php">
                                        <div class="modal-body">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="submit" name="btn-remove-product" id="send" class="btn btn-primary text-white">Delete</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
