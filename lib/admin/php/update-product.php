...
if (isset($_SESSION['this-is-an-incoming-super-admin'])) {
    ...
    if (isset($_POST['submit-update-request'])) {
        $productId = $_POST['incoming-product-id'];
    }

    $request = new PaymentRequest;
    $products = $request->fetchProductById($productId);
} else {
    ...
    <section class="admin-content " id="contact-search">
        ...
        <section class="pull-up">
            ...
            <div class="container">
                ...
                <div class="row list d-flex justify-content-center">
                    ...
                    <div class=" col-lg-6 col-md-6 mb-3">
                        ...
                        <div class="card border-0 " data-aos="fade-right">
                            ...
                            <div class="card-body  bg-dark text-white product-card-border">
                                <form action="includes/edit_product_inc.php" method="POST">
                                    ...
                                    <div class="timeline timeline-xs ">
                                        <div class="timeline-item">
                                            <div class="timeline-wrapper">
                                                ...
                                                <div class="col-auto form-group">
                                                    <input class="form-control form-control-lg" name="product-name" type="text" value="<?php echo $products['product_name'] ?>">
                                                </div>
                                            </div>
                                        ...
                                        <div class="timeline-item">
                                            <div class="timeline-wrapper">
                                                ...
                                                <div class="col-auto form-group">
                                                    <input class="form-control form-control-lg" name="product-link" type="text" value="<?php echo $products['product_link'] ?>">
                                                </div>
                                            </div>
                                        ...
                                        <div class="timeline-item">
                                            <div class="timeline-wrapper">
                                                ...
                                                <div class="col-auto form-group">
                                                    <input type="hidden" name="incoming-update-productId" value="<?php echo $productId ?>">
                                                    <textarea class="form-control form-control-lg" rows="4" cols="20" name="product-desc" id="comment" value="<?php echo $products['product_desc'] ?>"><?php echo $products['product_desc'] ?></textarea>
                                                </div>
                                            </div>
                                        ...
                                        <div class="timeline-item ">
                                            ...
                                            <button name="update-product-inc" class="btn bg-info text-white mt-2">Update Product</button>
