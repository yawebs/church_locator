...
if (isset($_SESSION['this-is-an-incoming-super-admin'])) {
    ...
    if (isset($_SESSION['action-result'])) {
        $actionResult = $_SESSION['action-result'];
    }

    $fetchReps = new PaymentRequest;
    $reps = $fetchReps->fetchAllReps();
} else {
                ...
                <div class="container">
                    <div class="row p-b-60 p-t-60">
                        ...
                        <div class="col-md-6 text-center mx-auto text-white p-b-30">
                            ...
                            <h3>Search For Reps </h3>
                            <p class="text-success"><?php echo $actionResult;
                                                    unset($_SESSION['action-result']) ?></p>
                            <form>
                                <div class="form-dark">
                            ...
                            <div class="col-lg-4 col-md-6 " id="dataViewer">
                                ...
                                <div class="card m-b-30">
                                    ...
                                    <div class="card-body">
                                        ...
                                        require_once '../../includes/dbh.inc.php';
                                        require_once '../../func/prequest.php';
                                        $repcount = new PaymentRequest;
                                        $totalRep = $repcount->getRepTotalRef($rep['id']);
                                        ?>
                                        <div class="text-muted text-center m-b-10">
                                            Total Referrals <a class="btn btn-sm btn-white"><?php echo $totalRep; ?></a>
                                        ...
                                        <form action="actions.php" method="POST">
                                            <div class="row text-center p-b-10">
                                                <div class="col">
                                                    ...
                                                    <div class="form-group"> <input type="hidden" name="current-rep-id" value="<?php echo $rep['id'] ?>"></div>
