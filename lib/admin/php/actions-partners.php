...
if (isset($_SESSION['this-is-an-incoming-super-admin'])) {
    ...
    if (isset($_POST['btn-remove-current-part'])) {
        ...
        $repRequest = $request->fetchSinglePartner($repId);
                    ...
                    <div class="col-lg-6 col-md-6 ">
                        ...
                        <div class="card m-b-30">
                            ...
                            <div class="card-body">
                                ...
                                <form action="includes/part_options_inc.php" method="POST">
                                    <div class="row text-center p-b-10">

                                        <div class="col form-group">
                                            <div class="form-group"> <input type="hidden" name="current-part-id" value="<?php echo $repId; ?>"></div>
