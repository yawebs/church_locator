...
if (isset($_SESSION['media-error'])) {
    $error = $_SESSION['media-error'];
    $success = $_SESSION['media-success'];
}
                        ...
                        <div class="col-md-6 col-lg-6">
                            ...
                            <div class="card m-b-30">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="includes/media_upload_inc.php" method="POST" enctype="multipart/form-data">
                                        <div class="text-center m-t-20">

                                            <input type="file" name="file" class="btn text-white mt-2" style="background-color: grey;"> image</button>
                                        </div>
                                        ...
                                        <?php { ?>
                                            <div class="">
                                                <p class="text-danger">
                                                    <?php echo $error;
                                                    unset($_SESSION['media-error']) ?>
                                                </p>
                                                <p class="text-success">
                                                    <?php echo $success;
                                                    unset($_SESSION['media-success']) ?>
                                                </p>
                                                <p>MEDIA DETAILS</p>
                                            </div>
                                        <?php } ?>
                                        <div class="timeline timeline-xs ">
                                            <div class="timeline-item">
                                                <div class="timeline-wrapper">
                                                    ...
                                                    <div class="col-auto form-group">
                                                        <input class="form-control form-control-lg" name="media-name" type="text" placeholder="Product Name">
                                                        <input type="file" name="file2" class="btn bg-info text-white mt-2">attachment</button>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="timeline-item ">
                                                ...
                                                <button name="upload-media" class="btn bg-info text-white mt-2">Save Media</button>
