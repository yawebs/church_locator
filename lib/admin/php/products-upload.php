...
$error = $_SESSION['error-product'];
$success = $_SESSION['success-product'];
                        ...
                        <div class="col-md-8 col-lg-8">
                            ...
                            <div class="card m-b-30">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="includes/prodcut_upload_inc.php" method="POST" enctype="multipart/form-data">
                                        <h4 class="text-center m-t-20">

                                            <input type="file" name="file" class="btn bg-info text-white mt-2"></button>
                                        </h4>
                                        ...
                                        <div class="timeline timeline-xs ">
                                            <div class="timeline-item">
                                                <div class="">
                                                    ...
                                                    <div class="col-auto form-group">
                                                        <input class="form-control form-control-lg" name="churchName" type="text" placeholder="Church name">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="timeline-item">
                                                <div class="">
                                                    ...
                                                    <div class="col-auto form-group">
                                                        <input class="form-control form-control-lg" name="address" type="text" placeholder="Full Address">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="timeline-item">
                                                <div class="">
                                                    ...
                                                    <div class="col-auto form-group">
                                                        <input class="form-control form-control-lg" name="city" type="text" placeholder="City">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="timeline-item">
                                                <div class="">
                                                    ...
                                                    <div class="col-auto form-group">
                                                        <input class="form-control form-control-lg" name="lga" type="text" placeholder="LGA">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="timeline-item">
                                                <div class="">
                                                    ...
                                                    <div class="col-auto form-group">
                                                        ...
                                                        <textarea class="form-control form-control-lg" rows="4" cols="20" name="others" id="comment" placeholder="other Info(Optional)"></textarea>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="timeline-item ">
                                                ...
                                                <button name="upload-product" class="btn bg-info text-white mt-2">Upload Church</button>
